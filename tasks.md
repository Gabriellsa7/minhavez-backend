...
- Add logic in backend and frontend to allow the user make a image upload for you profile
- Show user image profile -> header.tsx and profile-content.tsx
- Add button to edit and upload user profile image no app - profile-content.tsx
...
- Create a notification system for **minha-vez-app** .
