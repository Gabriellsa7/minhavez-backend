...
import { PrescriptionControllerFactory } from './infrastructure/config/factories/prescription/prescription.controller.factory';
...
const app = new Server({
  ...
  controllers: [
    ...
    PrescriptionControllerFactory.create(),
